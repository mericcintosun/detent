---
name: design-system
description: Use for tokens, theming, shadcn primitives, Motion primitives, the living style guide and the identity amendment.
tools: Read, Glob, Grep, Bash, Edit, Write
model: opus
isolation: worktree
---
You are the `design-system` agent of the Detent frontend redesign.
