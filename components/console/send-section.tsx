...
export function SendSection({ c }: { c: ConsoleController }) {
  ...
  return (
    ...
    >
      <Card
        className={cn(
          settlement && !settlement.verdict.allowed && "ring-destructive",
        )}
      >
            ...
            <div className="flex min-w-0 flex-col gap-4 border border-border bg-background p-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  aria-invalid={c.tamperNotice?.kind === "invalid" || undefined}
                ...
                >
                  ...
                  payload, so a single altered byte falls through to the
                  default.
                </p>
